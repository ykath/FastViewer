...
- Android：`LightPage_1.1.2_android-debug.apk`
- Windows 免安装版：`LightPage_1.1.2_windows-x64.exe`
- Windows 安装包：`LightPage_1.1.2_windows-x64-setup.exe`
...
- Windows 保持单文件阅读，支持拖放打开、外部修改刷新、命令面板、同目录文档切换与常用目录收藏
