...
set "NSIS_INSTALLER=%MOBILE_APP%\src-tauri\target\release\bundle\nsis\LightPage_%APP_VERSION%_x64-setup.exe"
...
copy /Y "%NSIS_INSTALLER%" "%OUTPUT_DIR%\LightPage_%APP_VERSION%_windows-x64-setup.exe" >nul
